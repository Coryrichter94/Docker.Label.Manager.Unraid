        ...
        <form id="label-injector-form" class="label-injector-form">
            ...
            <div class="label-injector-notes" style="position: relative;">
                ...
                <div id="inline-preset-config" style="display:none; background: #232323; padding: 15px; border-radius: 6px; border: 1px solid #444; margin-top: 10px; text-align: left;">
                    <h4 id="inline-preset-title" style="margin-top:0; margin-bottom: 15px; color: #fff;">Preset Config</h4>
                    <div id="inline-preset-inputs"></div>
                    <div style="margin-top: 15px; text-align: right; display: flex; justify-content: flex-end; gap: 10px;">
                        <button type="button" class="btn-remove-all" onclick="$('#inline-preset-config').hide();" style="margin-top: 0; float: none;">Cancel</button>
                        <button type="button" class="btn-preset" onclick="applyPresetConfig()" style="margin-top: 0;">Add Labels</button>
                    </div>
                </div>
            </div>
...
function showPresetConfig(type) {
    ...
    const inputStyle = 'width: 100%; padding: 8px; margin-bottom: 0px; border-radius: 4px; border: 1px solid #555; background: #333; color: #fff; box-sizing: border-box; font-size: 13px;';
    const labelStyle = 'display: block; margin-bottom: 5px; color: #ccc; font-size: 13px; font-weight: normal;';
